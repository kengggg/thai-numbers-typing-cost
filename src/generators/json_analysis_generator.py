    ...
    def _generate_metadata(self, stats: Dict) -> Dict[str, Any]:
        ...
        return {
            ...
            "document_stats": {
                ...
                "digit_percentage": round(stats['document_stats']['digit_percentage'], 2),
                "thai_digits": sum(stats['digit_analysis']['thai_digit_breakdown'].values()),
                "international_digits": sum(stats['digit_analysis']['intl_digit_breakdown'].values())
            },
            ...
            results_by_profile[profile_key] = {
                "scenarios": {
                    scenario_key: {
                        ...
                        "average_cost_per_char_ms": round(scenario['average_cost_per_char'] * 1000, 1),
        ...
        return {
            "q1": {
                ...
                "details": {
                    ...
                    "total_digits_typed": sum(data['count'] for data in scenarios['thai_kedmanee']['digit_costs'].values() if data['count'] > 0)
                }
            },
            "q2": {
                ...
                "details": {
                    "time_saved_vs_thai": round(scenarios['thai_kedmanee']['total_cost_minutes'] - scenarios['intl_kedmanee']['total_cost_minutes'], 1),
                    "percentage_saved": round(safe_percentage(scenarios['thai_kedmanee']['total_cost_minutes'] - scenarios['intl_kedmanee']['total_cost_minutes'], scenarios['thai_kedmanee']['total_cost_minutes']), 1),
            ...
            "q3": {
                ...
                "details": {
                    "time_saved_vs_kedmanee": round(scenarios['thai_kedmanee']['total_cost_minutes'] - scenarios['thai_pattajoti']['total_cost_minutes'], 1),
                    "percentage_saved": round(safe_percentage(scenarios['thai_kedmanee']['total_cost_minutes'] - scenarios['thai_pattajoti']['total_cost_minutes'], scenarios['thai_kedmanee']['total_cost_minutes']), 1),
            ...
            "q4": {
                ...
                "details": {
                    "time_saved_vs_current": round(scenarios['thai_kedmanee']['total_cost_minutes'] - scenarios['intl_pattajoti']['total_cost_minutes'], 1),
                    "percentage_saved": round(safe_percentage(scenarios['thai_kedmanee']['total_cost_minutes'] - scenarios['intl_pattajoti']['total_cost_minutes'], scenarios['thai_kedmanee']['total_cost_minutes']), 1),
            ...
            "q5": {
                ...
                "details": {
                    "per_document_loss_minutes": round(scenarios['thai_kedmanee']['total_cost_minutes'] - scenarios['intl_pattajoti']['total_cost_minutes'], 1),
                    "efficiency_loss_percentage": round(safe_percentage(scenarios['thai_kedmanee']['total_cost_minutes'] - scenarios['intl_pattajoti']['total_cost_minutes'], scenarios['thai_kedmanee']['total_cost_minutes']), 1),
