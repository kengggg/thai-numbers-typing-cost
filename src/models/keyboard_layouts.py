...
class KedmaneeLayout(ThaiKeyboardLayout):
    ...
    def _initialize_layout(self):
        ...
        intl_digits = {
            ...
            '3': KeyInfo('3', requires_shift=False, hand="left", finger="middle", row=3),
            ...
            '6': KeyInfo('6', requires_shift=False, hand="right", finger="index", row=3),
            '7': KeyInfo('7', requires_shift=False, hand="right", finger="index", row=3),
        ...
        thai_characters = {
            ...
            'พ': KeyInfo('พ', requires_shift=False, hand="left", finger="middle", row=2),
            ...
            'ร': KeyInfo('ร', requires_shift=False, hand="right", finger="index", row=2),
            ...
            'ก': KeyInfo('ก', requires_shift=False, hand="left", finger="middle", row=1),
            ...
            'แ': KeyInfo('แ', requires_shift=False, hand="left", finger="middle", row=0),
            ...
            'ท': KeyInfo('ท', requires_shift=False, hand="right", finger="index", row=0),
            ...
            'ญ': KeyInfo('ญ', requires_shift=True, hand="right", finger="middle", row=2),  # Shifted น
            'ณ': KeyInfo('ณ', requires_shift=True, hand="right", finger="index", row=2),  # Shifted ร
            'ค': KeyInfo('ค', requires_shift=True, hand="left", finger="index", row=1),  # Shifted ด
            'ต': KeyInfo('ต', requires_shift=True, hand="left", finger="index", row=0),  # Shifted อ
            'จ': KeyInfo('จ', requires_shift=True, hand="left", finger="index", row=1),  # Shifted เ
            ...
            ',': KeyInfo(',', requires_shift=False, hand="right", finger="middle", row=0),
...
class PattajotiLayout(ThaiKeyboardLayout):
    ...
    def _initialize_layout(self):
        ...
        thai_digits = {
            ...
            '๔': KeyInfo('๔', requires_shift=False, hand="left", finger="middle", row=3),
            '๕': KeyInfo('๕', requires_shift=False, hand="left", finger="index", row=3),
            '๗': KeyInfo('๗', requires_shift=False, hand="left", finger="index", row=3),  # stretch
            '๘': KeyInfo('๘', requires_shift=False, hand="right", finger="index", row=3),
            '๙': KeyInfo('๙', requires_shift=False, hand="right", finger="index", row=3),  # stretch
            '๐': KeyInfo('๐', requires_shift=False, hand="right", finger="middle", row=3),
        ...
        thai_characters = {
            ...
            'ค': KeyInfo('ค', requires_shift=False, hand="left", finger="middle", row=2),
            ...
            'ง': KeyInfo('ง', requires_shift=False, hand="right", finger="index", row=2),
            'จ': KeyInfo('จ', requires_shift=False, hand="right", finger="index", row=2),
            ...
            'น': KeyInfo('น', requires_shift=False, hand="left", finger="middle", row=1),
            ...
            'ล': KeyInfo('ล', requires_shift=False, hand="right", finger="index", row=1),
            'ว': KeyInfo('ว', requires_shift=False, hand="right", finger="index", row=1),
            ...
            'พ': KeyInfo('พ', requires_shift=False, hand="left", finger="middle", row=0),
            ...
            'ม': KeyInfo('ม', requires_shift=False, hand="right", finger="index", row=0),
            'ด': KeyInfo('ด', requires_shift=False, hand="right", finger="index", row=0),
            ...
            'ะ': KeyInfo('ะ', requires_shift=False, hand="left", finger="index", row=2),
            'ั': KeyInfo('ั', requires_shift=False, hand="left", finger="index", row=2),
            '่': KeyInfo('่', requires_shift=False, hand="right", finger="index", row=1),  # Mai ek
            '้': KeyInfo('้', requires_shift=False, hand="right", finger="index", row=1),  # Mai tho
